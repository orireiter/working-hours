import { IconExclamationCircle, IconCircleCheck, IconLogout, IconLogin, IconHome, IconMoon, IconSun, IconBriefcase, IconPlus, IconArrowDown } from '@tabler/icons-react';
...
const enumToComopnent = {
    ...
    [IconEnum.DOWN_ARROW]: IconArrowDown,
};
